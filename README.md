...
`v0.1.7` release and the live npm registry both list
`@preflight-scout/cli@0.1.7`. If either is missing, do not run the registry
install.
...
both the GitHub `v0.1.7` release and `@preflight-scout/cli@0.1.7` exist, then run
