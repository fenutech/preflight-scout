...
`v0.1.5` release and the live npm registry both list
`@preflight-scout/cli@0.1.5`. If either is missing, do not run the registry
install.
...
both the GitHub `v0.1.5` release and `@preflight-scout/cli@0.1.5` exist, then run
