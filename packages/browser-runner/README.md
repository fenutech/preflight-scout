...
Playwright browser execution boundary for Preflight Scout live LLM missions.
...
```bash
npm install @preflight-scout/browser-runner@0.1.2 --registry=https://registry.npmjs.org/
```
