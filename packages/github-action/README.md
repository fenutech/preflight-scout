...
GitHub Action entrypoint for Preflight Scout PR reports and browser evidence.
...
```bash
npm install @preflight-scout/github-action@0.1.2 --registry=https://registry.npmjs.org/
```
