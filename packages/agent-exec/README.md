...
OpenAI Codex, Claude Code, Gemini CLI, and custom agent handoffs for Preflight Scout missions.
...
```bash
npm install @preflight-scout/agent-exec@0.1.3 --registry=https://registry.npmjs.org/
```
