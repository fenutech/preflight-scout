...
Core PR impact mapping, QA mission planning, contracts, reports, and provider adapters for Preflight Scout.
...
After the official v0.1.3 release and the live npm registry
both list this exact package version:

```bash
npm install @preflight-scout/core@0.1.3 --registry=https://registry.npmjs.org/
```
