...
`@preflight-scout/cli@0.1.2`. If either is missing, skip this install and use the
source path below.
...
confirm the GitHub `v0.1.2` release and npm package both exist, install the exact
`@preflight-scout/cli@0.1.2` package from [Install the CLI](#install-the-cli),
